...
public class CalculatorImpl extends UnicastRemoteObject implements Calculator {
    ...
    /**    (non-Javadoc)
     * 
     * @see br.com.meslin.rmitls.shared.Calculator#adicionar(double, double)
     */
    @Override
    ...
    /**    (non-Javadoc)
     * 
     * @see br.com.meslin.rmitls.shared.Calculator#subtrair(double, double)
     */
    @Override
    ...
    /**    (non-Javadoc)
     * 
     * @see br.com.meslin.rmitls.shared.Calculator#multiplicar(double, double)
     */
    @Override
    ...
    /**    (non-Javadoc)
     * 
     * @see br.com.meslin.rmitls.shared.Calculator#dividir(double, double)
     */
    @Override
